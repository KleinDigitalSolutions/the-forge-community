...
import { SendHorizontal, Sparkles, Lock } from 'lucide-react';
...
export default function CommunicationPage() {
  ...
  const isLocked = useMemo(() => providerOptions.find((p) => p.id === selectedProvider)?.status === 'disabled', [selectedProvider]);
