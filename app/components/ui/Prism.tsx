...
const Prism = ({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (suspendWhenOffscreen) {
        const containerAny = container as HTMLDivElement & { __prismIO?: IntersectionObserver };
        if (containerAny.__prismIO) containerAny.__prismIO.disconnect();
        delete containerAny.__prismIO;
      }
