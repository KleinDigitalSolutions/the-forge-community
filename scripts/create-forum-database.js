...
async function createForumDatabase() {
  console.log('Creating THE FORGE - Forum Database...\n');
  ...
  try {
    ...
    console.log('Forum database created!');
    console.log(`\nDatabase ID: ${database.id}`);
    console.log('\nAdd to your .env.local:');
    console.log(`NOTION_FORUM_DATABASE_ID=${database.id}`);
